            ...
            <div class="page-title-box d-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        ...
                        <li class="breadcrumb-item active">Rekap Proposal Pengabdian</li>
                    </ol>
                </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">Rekap Proposal Pengabdian</h4>
                    <table id="datatable" class="table table-bordered owrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                        ...
                        @foreach($datas as $data)
                            <tr>
                                ...
                                <td>{{$data->tahun}}</td>
                                <td>
                                    <a href="{{ route('admin.pengabdian.download', [ $data->proposal, $data->jenis_proposal]) }}">download</a>
                                </td>
                                <td>
                                    @if($data->penilaian != null)
                                        <a href="{{ route('admin.pengabdian.download.penilaian', [ $data->penilaian, $data->jenis_proposal]) }}">download</a>
                                    @else
                                        <p><span class="badge badge-success">belum di nilai</span></p>
                                    @endif
                                </td>
                                    ...
                                    <div class="modal-dialog modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{ route('admin.pengabdian.reviewer.choose') }}" method="post">
                                                    @csrf
...
@section('script')
    <script>
        ...
        function getData(id) {
            return  fetch('pengabdian/'+id+'/reviewer')
                .then(res => res.json())
                .then(res => res)
        }
