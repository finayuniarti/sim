                ...
                <table id="datatable" class="table table-bordered dt-responsive nowrap"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a
                                    href="{{ route('reviewer.penelitian.download', $data->proposal) }}">{{$data->proposal}}</a>
                            </td>
                            <td>
                            ...
                            <td>
                                @if($data->revisi == '1')
                                <a href="{{route('reviewer.penelitian.get_revisi_proposal', $data->id)}}"
                                    class="btn btn-warning btn-sm"><i class="mdi mdi-pencil"></i></a>

                                @endif
                                @if($data->revisi == '1' && $data->status == '1')
                                <a href="{{route('reviewer.penelitian.acc_proposal', $data->id)}}"
                                    class="btn btn-warning btn-sm">Acc</a>
                                @endif
                                <a href="{{route('reviewer.penelitian.nilai', $data->id)}}"
