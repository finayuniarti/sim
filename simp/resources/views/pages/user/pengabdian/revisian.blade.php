                            ...
                            <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                ...
                                @foreach($datas as $data)
                                    <tr>
                                        ...
                                        <td>{{$data->nominal}}</td>
                                        <td>
                                            <a href="{{ route('user.pengabdian.download', $data->proposal) }}">{{$data->proposal}}</a>
                                        </td>
                                        <td>
                                            <a href="{{ route('user.pengabdian.download', $data->revisi_proposal) }}">{{$data->revisi_proposal}}</a>
                                        </td>
                                        @if($data->revisi == '2')
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form
                                                        action="{{ route('user.pengabdian.uploadProposalAgain', $data->id) }}"
