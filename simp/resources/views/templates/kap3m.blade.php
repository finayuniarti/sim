...
@include('templates.partials.kap3m._head')
...
<div id="layout-wrapper">
    ...
    @include('templates.partials.kap3m._navbar')
    <!-- ========== Left Sidebar Start ========== -->
    <div class="vertical-menu">
        ...
        <div data-simplebar class="h-100">
            ...
            <!--- Sidemenu -->
    @include('templates.partials.kap3m._sidebar')
            <!-- Sidebar -->
        </div>
    </div>
    <!-- Left Sidebar End -->
...
@yield('content')
        ...
        @include('templates.partials.kap3m._footer')
    </div>
    <!-- end main content-->
...
@include('templates.partials.kap3m._script')
</body>
