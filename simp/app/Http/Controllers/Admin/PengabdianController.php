...
class PengabdianController extends Controller
{
    public function index()
    {
        ...
        $datas = P3M::where('jenis_proposal','pengabdian')->get();
        return view('pages.admin.judul.pengabdian.index', compact('datas'));
    }
    ...
    public function chooseReviewer(Request $request)
    {
        ...
        return redirect()->route('admin.judul.pengabdian.index')->with('success', 'berhasil memilih reviewer');
    }
}
